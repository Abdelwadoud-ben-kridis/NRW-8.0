...
export const EN = {
  ...
  askOldest: "Or just take whichever box is oldest and ready (any reference)",
  ...
  boxPick: "Box", askBox: "Request box",
  unitsN: (n) => `${n} units`, nextOutShort: "next out",
  noBoxes: "No box in stock yet.", noReadyBoxes: "— no box ready yet —",
  readyInShort: (h) => `ready in ${h} h`,
  boxIsHead: (ref) => `Oldest ready ${ref} box — FIFO OK.`,
  boxOverride: (head) => `Ready — you can take it. FIFO would take ${head} first (older); the skip will be recorded.`,
  boxCuring: (h) => `Still curing — ready in ${h} h. This request will be refused.`,
  fifoSkipped: (head) => `FIFO skipped: ${head} was older`,
  useFirst: (id) => `ready instead: ${id}`,
  etaBox: (clockLabel) => `ready at ${clockLabel}`,
  detOlderSkipped: (id) => `older than ${id} — FIFO suggested this one first`,
  detGoesFirst: (id) => `${id} goes out first`,
  warehouse: "Warehouse",
  ...
  ev: {
    ...
    clock_speed: "speed", article_new: "new reference",
  ...
  rej: {
    ...
    "choix operateur": "skipped — operator's choice",
  },
  det: {
...
export const FR = {
  ...
  askOldest: "Ou prendre simplement le box le plus ancien et prêt (toute référence)",
  ...
  boxPick: "Box", askBox: "Demander le box",
  unitsN: (n) => `${n} unités`, nextOutShort: "prochain sorti",
  noBoxes: "Aucun box en stock pour l'instant.", noReadyBoxes: "— aucun box prêt —",
  readyInShort: (h) => `prêt dans ${h} h`,
  boxIsHead: (ref) => `Box ${ref} prêt le plus ancien — FIFO respecté.`,
  boxOverride: (head) => `Prêt — vous pouvez le prendre. Le FIFO prendrait ${head} d'abord (plus ancien) ; l'écart sera enregistré.`,
  boxCuring: (h) => `Encore en séchage — prêt dans ${h} h. Cette demande sera refusée.`,
  fifoSkipped: (head) => `FIFO ignoré : ${head} était plus ancien`,
  useFirst: (id) => `prêt à la place : ${id}`,
  etaBox: (clockLabel) => `prêt à ${clockLabel}`,
  detOlderSkipped: (id) => `plus ancien que ${id} — le FIFO le proposait en premier`,
  detGoesFirst: (id) => `${id} sort en premier`,
  warehouse: "Entrepôt",
  ...
  ev: {
    ...
    clock_speed: "vitesse", article_new: "nouvelle référence",
  ...
  rej: {
    ...
    "choix operateur": "écarté — choix de l'opérateur",
  },
  det: {
