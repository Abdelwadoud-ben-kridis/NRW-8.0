...
export const EN = {
  ...
  noBoxes: "No box in stock yet.",
  boxIsHead: (ref) => `Oldest ready ${ref} box — FIFO OK.`,
  boxNotHead: (head) => `FIFO: ${head} is older and ready — this request will be refused. Take ${head} first.`,
  boxCuring: (h) => `Still curing — ready in ${h} h. This request will be refused.`,
  useFirst: (id) => `FIFO: use ${id} first`,
  etaBox: (clockLabel) => `ready at ${clockLabel}`,
  detUseFirst: (id) => `take ${id} first`,
...
export const FR = {
  ...
  noBoxes: "Aucun box en stock pour l'instant.",
  boxIsHead: (ref) => `Box ${ref} prêt le plus ancien — FIFO respecté.`,
  boxNotHead: (head) => `FIFO : ${head} est plus ancien et prêt — cette demande sera refusée. Prendre ${head} d'abord.`,
  boxCuring: (h) => `Encore en séchage — prêt dans ${h} h. Cette demande sera refusée.`,
  useFirst: (id) => `FIFO : utiliser ${id} d'abord`,
  etaBox: (clockLabel) => `prêt à ${clockLabel}`,
  detUseFirst: (id) => `prendre ${id} d'abord`,
